                                ...
                                <div class="row">
                                    <form action="{{ URL::to('updatehoroscope') }}" method="post"
                                        ...
                                        <div class="form-group">
                                            <label for="dailyscope1">Personal Life</label>
                                            <input type="hidden" name="horoscopetype" value="D">
                                            <input type="file" id="dailyscope1" name="files[]"
                                                class="form-control dailyhoroscopefile" accept=".csv">
                                            <p class="help-block">Note: Supported File format: .csv
                                            </p>
                                        </div>

                                        <div class="form-group">
                                            <label for="dailyscope2">Education</label>
                                            <input type="hidden" name="horoscopetype" value="D">
                                            <input type="file" id="dailyscope2" name="files[]"
                                                class="form-control dailyhoroscopefile" accept=".csv">
                                            <p class="help-block">Note: Supported File format: .csv
                                            </p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="dailyscope3">Career</label>
                                            <input type="hidden" name="horoscopetype" value="D">
                                            <input type="file" id="dailyscope3" name="files[]"
                                                class="form-control dailyhoroscopefile" accept=".csv">
                                            <p class="help-block">Note: Supported File format: .csv
                                            </p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="dailyscope4">Health</label>
                                            <input type="hidden" name="horoscopetype" value="D">
                                            <input type="file" id="dailyscope4" name="files[]"
                                                class="form-control dailyhoroscopefile" accept=".csv">
                                            <p class="help-block">Note: Supported File format: .csv
                                            </p>
                                        </div>
